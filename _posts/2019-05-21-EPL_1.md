...
[^2]: It is probably worth pointing out that with an average of 33% of games being worth watching, that the classifier which always predicts a game will be dull will be correct 67% of the time. However, with that predictor we would never watch any football! The values in the confusion matrix prove that my model is not working that way.