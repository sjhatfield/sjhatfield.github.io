...
To view the code used to perform the regression and read a more in-depth explanation of the matheamtics involved, please follow the link to the [notebook](https://github.com/sjhatfield/worthwatching/blob/master/EPL_LogisticRegression.ipynb).
...
So if the model tells you to watch a game you have a $$\frac{139}{350} = 39.7\%$$ of it being exciting. This is slightly better than random selection but still not good enough for me to be satisfied. A different modeling approach is needed...
